  ...
  const languages = {
    ...
    es: {
      ...
      messages: {
        ...
        'running': 'en ejecución', 'stale': 'sin actualizaciones', 'late': 'con retraso', 'succeeded': 'completado', 'failed': 'con errores', 'cancelled': 'cancelado',
    ...
    'pt-BR': {
      ...
      messages: {
        ...
        'running': 'em execução', 'stale': 'sem atualizações', 'late': 'atrasado', 'succeeded': 'concluído', 'failed': 'com falha', 'cancelled': 'cancelado',
    ...
    de: {
      ...
      messages: {
        ...
        'running': 'läuft', 'stale': 'keine Updates', 'late': 'verspätet', 'succeeded': 'erfolgreich', 'failed': 'fehlgeschlagen', 'cancelled': 'abgebrochen',
